...
+(NSString*)getChineseCalendarWithDate:(NSDate *)date{  
    ...
    NSArray *chineseDays=[NSArray arrayWithObjects:  
                          ...
                          @"廿一", @"廿二", @"廿三", @"廿四", @"廿五", @"廿六", @"廿七", @"廿八", @"廿九", @"三十", @"初一",  nil];  
...
+(NSString *)getXingqi:(NSDate *)date
{
    ...
    NSInteger xingqi = comps.weekday;
    NSString *xingqiStr;
    switch (xingqi)
    {
        case 1:
...
+(NSComparisonResult)Date1:(NSString *)date1 Date2:(NSString *)date2
{
    ...
    NSDate *dateStart = [myDateFormatter dateFromString:date1];
    NSDate *dateEnd = [myDateFormatter dateFromString:date2];
...
+(NSDate *)lastDate:(NSDate *)date
{
    ...
    NSDate *yesterday = [cal dateByAddingComponents:components toDate: date options:0];
...
+(NSDate *)nextDate:(NSDate *)date
{
    ...
    NSDate *nextDay = [cal dateByAddingComponents:components toDate: date options:0];
    return nextDay;
}
// 获取前一个星期
