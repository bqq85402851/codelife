...
@interface BXQCropperViewController()
...
@end
@implementation BXQCropperViewController
- (void)dealloc {
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(BXQCropperDelgate)]) {
...
-(UIImage *)getSubImage{
    //cropFrame 是裁剪区域的frame，latestFrame是缩放后最新的frame，cropframe是固定的，而lasteframe是动态变动的。
